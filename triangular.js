...
(function() {
    ...
    function routeConfig($stateProvider) {
        ...
        .state('triangular.admin-default', {
            ...
            views: {
                sidebarLeft: {
                    templateProvider: ["$templateCache", "$http", "triLayout", function($templateCache, $http, triLayout) {
